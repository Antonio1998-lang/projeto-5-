...
CREATE TABLE `registroconsulta` (
  ...
  `idPaciente` int DEFAULT NULL COMMENT 'chave estrangeira - cadastro paciente',
  `IdentificacaoAgenteSaude` int DEFAULT NULL COMMENT 'chave estrangeira - Cadastro Agente de Saúde',
  `Data` date DEFAULT NULL,
  `NomePosto` varchar(60) DEFAULT NULL,
  `descricaoConsulta` varchar(100) DEFAULT NULL,
